...
class TutorWelcomePage extends Component {
  logOut = () => {
    ...
    return (
      ...
      >
        ...
        <Grid container justify="center" style={{ marginTop: '80px' }}>
          ...
          {this.renderCard('Payroll', 'Check payroll', '/payroll')}
          {this.renderCard('Sessions Dashboard', 'View and manage sessions', '/dashboard')}
          {this.renderCard('Announcements', 'Manage announcements', '/announcements')}
        </Grid>
      </div>
    );
  }
...
export default withRouter(TutorWelcomePage);
