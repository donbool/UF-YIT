...
import backgroundImage from './pics/image.png';

class StudentWelcomePage extends Component {
  logOut = () => {
    ...
    return (
      ...
      >
        ...
        <Grid container justify="center" style={{ marginTop: '80px' }}>
          ...
          {this.renderCard('Announcements', 'View and manage sessions', '/dashboard')}
          {this.renderCard('Tasks', 'Manage attendance records', '/attendance')}
        </Grid>
      </div>
    );
  }
...
export default withRouter(StudentWelcomePage);
